<template>
  <div class="sink-source-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="数据源信息" prop="source_info">
          <el-input
            type="text"
            v-model="modifyNodeData.source_info"
            auto-complete="off"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="数据源系统" prop="source_data_system">
          <el-input
            type="text"
            v-model="modifyNodeData.source_data_system"
            auto-complete="off"
          ></el-input>
        </el-form-item>
    ...
    <el-dialog
      title="请填入新增节点的信息："
      :visible.sync="AddNodePageVisible"
      center
      :append-to-body="0"
      :lock-scroll="true"
      width="100%"
    ...
    >
      ...
      >
        ...
        <el-form-item label="数据源系统" prop="source_data_system">
          <el-input
            type="text"
            v-model="addNodeData.source_data_system"
            placeholder="请输入数据源系统(必填)"
            auto-complete="off"
          >
          </el-input>
        </el-form-item>
    ...
    <el-card style="margin-top: 20px">
      <div v-show="true" class="select">
        ...
        <span>
          <el-button
            type="primary"
            v-on:click="AddNodePageVisible = true"
            style="margin: 10px 0"
            >新增节点</el-button
          >
        </span>
