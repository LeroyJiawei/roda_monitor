  ...
  <div class="sink-source-container">
    ...
    <el-dialog title="修改页面" :visible.sync="ModifyPageVisible" width="50%" :before-close="handleModifyClose">
      ...
      <el-form :model="modifyNodeData" status-icon ref="modifyNodeData" label-width="130px" class="ModifyNodeInfo"
        ...
        <el-form-item label="id" prop="id">
          <el-input type="text" v-model="modifyNodeData.id"></el-input>
        </el-form-item>
        ...
        <el-form-item label="网络id" prop="network_id">
          <el-input type="text" v-model="modifyNodeData.network_id" auto-complete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="数据源系统" prop="source_data_system">
          <el-input type="text" v-model="modifyNodeData.source_data_system" auto-complete="off"></el-input>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="ModifyPageVisible = false;resetNodeForm('modifyNodeData')">取 消</el-button>
    ...
    <el-dialog title="请填入新增节点的信息：" :visible.sync="AddNodePageVisible" center :append-to-body='0' :lock-scroll="true"
      ...
      <el-form :model="addNodeData" status-icon ref="addNodeData" label-width="130px" class="AddNodeInfo"
        ...
        <el-form-item label="网络id" prop="network_id">
          <el-input type="text" v-model="addNodeData.network_id" placeholder='请输入网络id(必填)' auto-complete="off">
          </el-input>
        </el-form-item>
        ...
        <el-form-item label="数据源系统" prop="source_data_system">
          <el-input type="text" v-model="addNodeData.source_data_system" placeholder='请输入数据源系统(必填)' auto-complete="off">
          </el-input>
        </el-form-item>

        <el-form-item label="ap主机名" prop="ap_hostname">
          <el-input type="text" v-model="addNodeData.ap_hostname" placeholder='请输入ap主机名(role为"source"时必填)' auto-complete="off">
          </el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="AddNodePageVisible = false; resetNodeForm('addNodeData')">取 消</el-button>
        <el-button type="primary" @click="submitAddNode('addNodeData')"> 增加节点 </el-button>
      </div>
    ...
    <el-card style="margin-top:20px">
      ...
      <div v-show="true" class="select">
        ...
        　　<el-select filterable class="choice" v-on:change="indexSelect" v-model="edge_enum_choose">
          ...
          　　</el-select>
        <span>
          <el-button type="primary" v-on:click="AddNodePageVisible = true" style="margin:10px 0;">新增节点</el-button>
        </span>
      </div>
      ...
      <el-table :data="tableData" stripe :border="true" style="width: 100%" max-height="2500">
        ...
        <el-table-column prop="network_id" label="network_id">
        </el-table-column>
        ...
        <el-table-column prop="ap_hostname" label="ap主机名">
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      modifyARow(index) { // 弹出修改对话框
        ...
        this.modifyNodeData.source_data_system = this.tableData[index].source_data_system;
      ...
      submitModification(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            console.log(this.modifyNodeData);
            this.$axios
              ({
      ...
      // 新增节点相关函数：
      resetNodeForm(formName) {  //  重置，点击取消按钮后清空输入的节点信息
      ...
      async submitAddNode(formName) {  //  新增节点
        this.$refs[formName].validate((valid) => {
          if (valid) {
            // console.log(this.addNodeData);
            if(this.addNodeData.ap_hostname==''&&this.addNodeData.role=='source'){
              alert('当前role为‘source’,ap主机名是必填项！');
              return;
            }
            this.$axios
              ({
                url: `${window.$config.HOST}/api/sink_source/register`,
                method: 'post',
